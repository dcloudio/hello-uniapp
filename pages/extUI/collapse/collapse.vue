<template>
	<view>
		...
		<uni-section title="使用动画效果" type="line"></uni-section>
		<uni-collapse>
		...
		<!-- #endif -->
		<uni-section title="手风琴效果（只会保留一个的打开状态）" type="line"></uni-section>
		...
		<uni-section title="配置图片" type="line"></uni-section>
		<uni-collapse>
		...
		<uni-collapse>
			...
			<uni-collapse-item title="折叠内容使用 uni-list 组件">
				<uni-list>
					...
					<uni-list-item title="列表左侧带略缩图" note="列表描述信息" thumb="https://vkceyugu.cdn.bspapp.com/VKCEYUGU-dc-site/460d46d0-4fcc-11eb-8ff1-d5dcf8779628.png" thumb-size="lg" rightText="右侧文字" showArrow></uni-list-item>
